...
class LLaVATrainer(Trainer):
    ...
    #             "train": Dataset.from_dict({"input_id": [], "logits": []})
    #         })
    #     else:
    #         self.dataset_dict = load_from_disk(logit_save_path)
    ...
    #     new_data = {"input_id": input_ids_list, "logits": logits_list}
    #     self.dataset_dict["train"] = Dataset.from_dict(new_data).concatenate_datasets(self.dataset_dict["train"])

    #     # Save the dataset to disk
    #     self.dataset_dict.save_to_disk(self.logit_save_path)
